...
var Provider = __webpack_require__("./node_modules/react-redux/es/components/Provider.js");

// EXTERNAL MODULE: ./node_modules/react-redux/es/components/connectAdvanced.js
var connectAdvanced = __webpack_require__("./node_modules/react-redux/es/components/connectAdvanced.js");
...
var wrapMapToProps = __webpack_require__("./node_modules/react-redux/es/connect/wrapMapToProps.js");
...
var connect_mergeProps = __webpack_require__("./node_modules/react-redux/es/connect/mergeProps.js");

// EXTERNAL MODULE: ./node_modules/react-redux/es/connect/selectorFactory.js
var connect_selectorFactory = __webpack_require__("./node_modules/react-redux/es/connect/selectorFactory.js");
...
var demoMessages = ['So tasty! ' + String.fromCodePoint(0x1F60B), 'Mhh ... PIZZA ' + String.fromCodePoint(0x1F355), 'Oh yeah Pancakes! ' + String.fromCodePoint(0x1F95E)];
...
var createToast = exports.createToast = function createToast(options) {
...
var deleteToast = exports.deleteToast = function deleteToast(id) {
    return function (dispatch) {
...
/***/ "./src/component/DeliciousToasts.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _deliciousToasts = __webpack_require__("./src/action/deliciousToasts.js");

var _Toast = __webpack_require__("./src/component/Toast.js");

var _Toast2 = _interopRequireDefault(_Toast);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var DeliciousToasts = function DeliciousToasts(props) {
    var deleteToast = props.deleteToast,
        toasts = props.toasts;
    ...
    return _react2.default.createElement(
        ...
        toasts.map(function (toast) {
            ...
            return _react2.default.createElement(_Toast2.default, _extends({ key: id, onDismissClick: function onDismissClick() {
...
DeliciousToasts.propTypes = {
    deleteToast: _propTypes2.default.func.isRequired,

    toasts: _propTypes2.default.arrayOf(_propTypes2.default.object).isRequired
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        deleteToast: function deleteToast(id) {
            dispatch((0, _deliciousToasts.deleteToast)(id));
        }
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(DeliciousToasts);
    ...
    _createClass(Toast, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-link ml-auto align-self-center text-light toast__dismiss',
...
Toast.propTypes = {
    ...
    onDismissClick: _propTypes2.default.func.isRequired
};
...
exports.deleteToastAction = exports.createToastAction = exports.reducer = undefined;

var _DeliciousToasts = __webpack_require__("./src/component/DeliciousToasts.js");

var _DeliciousToasts2 = _interopRequireDefault(_DeliciousToasts);

var _deliciousToasts = __webpack_require__("./src/reducer/deliciousToasts.js");

var _deliciousToasts2 = _interopRequireDefault(_deliciousToasts);

var _deliciousToasts3 = __webpack_require__("./src/action/deliciousToasts.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _DeliciousToasts2.default;
var reducer = exports.reducer = _deliciousToasts2.default;
var createToastAction = exports.createToastAction = _deliciousToasts3.createToast;
var deleteToastAction = exports.deleteToastAction = _deliciousToasts3.deleteToast;

/***/ }),

/***/ "./src/reducer/deliciousToasts.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = function () {
    ...
    switch (type) {
        case _deliciousToasts.ADD_TOAST:
            return [payload].concat(_toConsumableArray(state));

        case _deliciousToasts.REMOVE_TOAST:
